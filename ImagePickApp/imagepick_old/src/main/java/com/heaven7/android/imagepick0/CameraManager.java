...
public final class CameraManager {
     ...
     */
    private final SimplePreviewCallback previewCallback;
    /**
     * Autofocus callbacks arrive here, and are dispatched to the Handler which requested them.
     */
    private final SimpleAutoFocusCallback autoFocusCallback;
    ...
    private CameraManager(Context context) {
        ...
        previewCallback = new SimplePreviewCallback(configManager);
        autoFocusCallback = new SimpleAutoFocusCallback();
    }
    ...
    public void handleFocus(MotionEvent event, Camera camera, int useWidth, int useHeight) {
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
   ...
   */
    ...
    public SimplePreviewCallback getPreviewCallback() {
        return previewCallback;
    }

    public SimpleAutoFocusCallback getAutoFocusCallback() {
